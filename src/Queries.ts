            ...
            if (currentProgram) {
                const {
                    ...
                    program: {
                        ...
                        params: {
                            fields: "programTrackedEntityAttributes[id,displayInList,trackedEntityAttribute[id,optionSetValue,name]]",
                        },
                    },
                });
                changeColumns([
                    ...
                    const processed = dimensions.map((dimension: string) => {
                        ...
                        return [
                            dimension,
                            {
                                ...
                                indicator: ind,
                                display:
                                    numerator.metaData.items[dimension].name,
                            },
                        ];
                    });
